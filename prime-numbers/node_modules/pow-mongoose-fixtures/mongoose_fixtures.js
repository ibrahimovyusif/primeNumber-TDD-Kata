...
console.log('TEST after loading mongoose in pow ');
...
var load = exports.load = function(data, db, callback) {
    if (typeof db === 'function') {
        callback = db;
        console.log('TEST fixtures loading ');
    ...
    if (typeof data == 'object') {
        ...
        console.log('TEST 33  fixtures loading', db);
...
function insertCollection(modelName, data, db, callback) {
    ...
    //Load model
    console.log('TEST insertCollection ');
